...
<head>
    <meta charset="UTF-8">
    <title>Ative seu acesso profissional</title>
</head>
<body style="font-family:Arial,Helvetica,sans-serif;color:#222;line-height:1.6;">
    <h1 style="font-size:24px;">Ative seu acesso profissional</h1>
    <p>Olá, <?= htmlspecialchars($nome, ENT_QUOTES, 'UTF-8') ?>.</p>
    <p>
        A empresa <strong><?= htmlspecialchars($empresa, ENT_QUOTES, 'UTF-8') ?></strong>
        liberou seu acesso profissional ao Salão Agenda.
    </p>
    ...
    <p>
        <a href="<?= htmlspecialchars($linkConfirmacao, ENT_QUOTES, 'UTF-8') ?>"
           style="display:inline-block;padding:12px 18px;background:#222;color:#fff;text-decoration:none;border-radius:6px;">
